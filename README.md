...
Foram implementadas todas as problemáticas solicitadas no projeto. Assim sendo, o projeto se encontra finalizado e será arquivado pois não há mais evoluções necessárias.
